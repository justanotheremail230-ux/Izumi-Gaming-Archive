        ...
        {selectedGame && (
          ...
          >
            ...
            >
              ...
              {selectedGame.cover && (
                <div className="relative w-52 h-[300px] mx-auto mb-6">
                  <Image
              ...
              <div className="text-center mb-6">
                ...
                <div className="flex justify-center flex-wrap gap-2">
                  ...
                  <span className="px-3 py-1 rounded-full bg-zinc-800 text-yellow-400 text-sm">★★★★★</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="bg-zinc-800/40 border border-zinc-800 rounded-xl p-4">
                  <p className="text-zinc-500 text-xs uppercase tracking-wider mb-1">Platform</p>
                  <p className="font-semibold text-white">PC</p>
                </div>
              </div>
